...
func main() {
	//privateKey, err := crypto.GenerateKey() //可以利用创建的钱包的私钥进行后续的使用
	//私钥  78539402791b5e1f766bfefb359a9a541f9ff9e2010068701cf722bb4ea5e755
	//if err != nil {
	//	log.Fatal(err)
	//}

	//使用私钥
	privateKey, err := crypto.HexToECDSA("78539402791b5e1f766bfefb359a9a541f9ff9e2010068701cf722bb4ea5e755")
	if err != nil {
		log.Fatal(err)
	}
